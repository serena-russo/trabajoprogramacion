...
.then(function(data){
    ...
    for (let i = 0 ; i<5; i++){
        lista_peliculas +=` <article><a class="popularesinicio" href="./resenapelis.html?id=${index_peliculas[i].id}"><img class="imagenapisearch" src="https://image.tmdb.org/t/p/w500${index_peliculas[i].poster_path}" alt="${index_peliculas[i].poster_path}"><p class="popularesinicio nombrepeliapi">${index_peliculas[i].title}</p></a></article>
...
.then(function(data){
    ...
    for (let i = 0 ; i<5; i++){
        lista_peliculas +=` <article><a class="popularesinicio" href="./resenaseries.html?id=${index_peliculas[i].id}"><img class="imagenapisearch" src="https://image.tmdb.org/t/p/w500${index_peliculas[i].poster_path}" alt="${index_peliculas[i].poster_path}"><p class="popularesinicio nombrepeliapi">${index_peliculas[i].title}</p></a></article>
